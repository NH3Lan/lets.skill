...
`lets.skill` is a Claude Code Skill that distills the expressive logic of China's most-studied lifestyle influencer into a usable framework.
...
| Framework | Logic |
|-----------|-------|
| **No Obligation to Share** | Asked about brands / prices / sources → block without explanation |
| **Tip-Toe Management** | Compensate for objective reality through posture and presentation |
| **Spend Less, Signal More** | Every displayed asset is worth less than it appears |
